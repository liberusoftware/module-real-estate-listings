...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-real-estate-listings?sort=semver)](https://github.com/liberusoftware/module-real-estate-listings/releases/latest) [![Tests](https://github.com/liberusoftware/module-real-estate-listings/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-real-estate-listings/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-real-estate-listings
```
...
<a href="https://github.com/liberusoftware/module-real-estate-listings/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-real-estate-listings" alt="Contributors to liberusoftware/module-real-estate-listings">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-real-estate-listings/graphs/contributors).
